  ...
  try {
    ...
    const userSeeds: UserSeed[] = [
      ...
      },
      {
        ...
        role: UserRole.BRANCH_MANAGER,
        branchId: asObjectId(branchByCode.EMR._id),
        isActive: true,
      },
      {
    ...
    const productSeeds: ProductSeed[] = [
      ...
      ...productTemplates.map((product) => ({
        ...
        branchId: asObjectId(branchByCode.EMR._id),
        reorderLevel: Math.max(5, Math.floor(product.reorderLevel / 2)),
        maxStockLevel: Math.floor(product.maxStockLevel / 2),
        quantityAvailable: 0,
        quantityInitial: 0,
        packSizes: [],
      ...
      // Lab dispensary products
      ...productTemplates.map((product) => ({
        ...product,
        sku: `${product.sku}-LAB`,
        barcode: `${product.barcode}4`,
        branchId: asObjectId(branchByCode.LAB._id),
        reorderLevel: Math.max(5, Math.floor(product.reorderLevel / 2)),
        maxStockLevel: Math.floor(product.maxStockLevel / 2),
        quantityAvailable: 0,
    ...
    const batchSeeds: BatchSeed[] = [
      ...
      // EMR branch batches
      {
        productId: asObjectId(productBySku['PAR-500-TAB-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'PAR-EMR-2601',
        expiryDate: expiry(18),
        quantityInitial: 100,
      ...
      {
        productId: asObjectId(productBySku['AMX-500-CAP-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'AMX-EMR-2602',
        expiryDate: expiry(11),
        quantityInitial: 60,
      ...
      {
        productId: asObjectId(productBySku['VITC-1000-EFF-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'VIT-EMR-2603',
        expiryDate: expiry(20),
        quantityInitial: 50,
      ...
      {
        productId: asObjectId(productBySku['ORS-SACHET-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'ORS-EMR-2604',
        expiryDate: expiry(9),
        quantityInitial: 200,
      ...
      {
        productId: asObjectId(productBySku['CET-10-TAB-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'CET-EMR-2605',
        expiryDate: expiry(16),
        quantityInitial: 80,
      ...
      {
        productId: asObjectId(productBySku['SALB-INH-100-EMR']._id),
        branchId: asObjectId(branchByCode.EMR._id),
        lotNumber: 'SALB-EMR-2606',
        expiryDate: expiry(14),
        quantityInitial: 30,
      ...
      // Lab dispensary batches
      {
        productId: asObjectId(productBySku['PAR-500-TAB-LAB']._id),
        branchId: asObjectId(branchByCode.LAB._id),
        lotNumber: 'PAR-LAB-2601',
        expiryDate: expiry(18),
        quantityInitial: 100,
        quantityAvailable: 80,
        purchasePrice: 22,
      ...
      {
        productId: asObjectId(productBySku['AMX-500-CAP-LAB']._id),
        branchId: asObjectId(branchByCode.LAB._id),
        lotNumber: 'AMX-LAB-2602',
        expiryDate: expiry(11),
        quantityInitial: 60,
        quantityAvailable: 45,
        purchasePrice: 68,
      ...
      {
        productId: asObjectId(productBySku['VITC-1000-EFF-LAB']._id),
        branchId: asObjectId(branchByCode.LAB._id),
        lotNumber: 'VIT-LAB-2603',
        expiryDate: expiry(20),
        quantityInitial: 50,
        quantityAvailable: 35,
        purchasePrice: 82,
      ...
      {
        productId: asObjectId(productBySku['ORS-SACHET-LAB']._id),
        branchId: asObjectId(branchByCode.LAB._id),
        lotNumber: 'ORS-LAB-2604',
        expiryDate: expiry(9),
        quantityInitial: 200,
        quantityAvailable: 150,
        purchasePrice: 7,
